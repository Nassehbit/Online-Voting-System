            ...
            <?php
              ...
              else
              {
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Azimio La Umoja One Kenya</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Amani National Agano Party</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Kenya Kwanza Party</strong><br>";
                  echo "
                  <div class='progress'>
                ...
                if(mysqli_num_rows($result)>0)
                {
                  ...
                  echo "<strong>Roots Party</strong><br>";
                  echo "
                  <div class='progress'>
